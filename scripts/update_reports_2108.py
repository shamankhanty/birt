...
registry_metric('birth', one('*рождении*24.08.26*.xlsx'), 'Доля медицинских свидетельств о рождении относительно актов гражданского состояния')
registry_metric('death', one('*смерти*24.08.26*.xlsx'), 'Доля медицинских свидетельств о смерти относительно актов гражданского состояния')
